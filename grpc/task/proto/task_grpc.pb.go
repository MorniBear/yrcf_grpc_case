...
const (
	Task_CreateTask_FullMethodName = "/YrcfAgent.Task/CreateTask"
	Task_ListTask_FullMethodName   = "/YrcfAgent.Task/ListTask"
	Task_AbortTask_FullMethodName  = "/YrcfAgent.Task/AbortTask"
	Task_DeleteTask_FullMethodName = "/YrcfAgent.Task/DeleteTask"
)
...
func (c *taskClient) ListTask(ctx context.Context, in *ListTaskRequest, opts ...grpc.CallOption) (*ListTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTaskResponse)
	err := c.cc.Invoke(ctx, Task_ListTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskServer) ListTask(context.Context, *ListTaskRequest) (*ListTaskResponse, error) {
